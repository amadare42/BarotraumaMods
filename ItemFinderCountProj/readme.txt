...
Format: <Item Name> [<non-empty>/<total on sub>] (+ <total carried>)
If all items are full (or cannot be empty), "<non-empty>" block isn't displayed.
If there are not items carried "(+ <total carried>)" block isn't displayed.